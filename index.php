...
$faq = [
    ...
    [
        "question" => "<h2>How does Google protect my privacy and keep my information secure?</h2>",
        "answer" =>
        "<div>
                ...
                <p><a href=''>Find out more</a> about how we keep your personal information private and safe – and put you in control.
            </div>"
    ],
    [
        "question" => "<h2>Why is my account associated with a country?</h2>",
        "answer" =>
        "<div>
    ...
    [
        "question" => "<h2>How can I remove information about myself from Google’s search results?</h2>",
        "answer" =>
        "<div>
                <p>Google search results are a reflection of the content publicly available on the web. Search engines can't remove content directly from websites, so removing search results from Google wouldn't remove the content from the web. If you want to remove something from the web, you should
                 <a href=''> contact the webmaster</a>of the site the content is posted on and ask him or her to make a change. Additionally, if under European data protection law, you would like to request removal of certain information about you that appears in Google's search results, please 
                  <a href='' click here</a>. Once the content has been removed and Google has noted the update, the information will no longer appear in Google's search results. If you have an urgent removal request, you can also visit our help page for more information. <a href=''> visit our help page for more information</a>.</p>
            </div>"
    ],
    [
        "question" => "<h2>Are my search queries sent to websites when I click on Google Search results?</h2>",
        "answer" =>
        "<div>
